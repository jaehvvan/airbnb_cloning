...
setInterval(function() {
	...
	if(scrollPos > 1) {
		...
		document.getElementById('menu_img').setAttribute('src', 'img/globe.png');
		document.getElementById('menu_img').setAttribute('class', 'img2_changed')
		for(var i = 0; i<5; i++)
		...
		document.getElementById('menu_img').setAttribute('src', "img/globe2.png");
		document.getElementById('menu_img').setAttribute('class', '')
